...
namespace Extend
{
    public static class NavMeshExporter
    {
        ...
        [UnityEditor.MenuItem("EZXR/导航/ExportToNavBin",false,650)]
        static void ExportToNavBin()
        {
            ...
            if (resultCode == 1)
                ...
                EditorUtility.DisplayDialog("Error", "Export Navmesh As NavBin File Failed!", "close");
        }

        [UnityEditor.MenuItem("EZXR/导航/ExportToNavBin", true,650)]
        static bool ValidateExportToNavBin()
        {
            return UserController.UserLogin;
        }

        [UnityEditor.MenuItem("EZXR/导航/Debug/ExportToJson",false,650)]
        ...
        [UnityEditor.MenuItem("EZXR/导航/Debug/ExportToJson", true,650)]
        static bool ValidateExportToJson()
        {
            return UserController.UserLogin;
        }

        [UnityEditor.MenuItem("EZXR/导航/Debug/ExportToObj",false,650)]
        ...
        [UnityEditor.MenuItem("EZXR/导航/Debug/ExportToObj", true,650)]
        static bool ValidateExportToObj()
        {
            return UserController.UserLogin;
        }
