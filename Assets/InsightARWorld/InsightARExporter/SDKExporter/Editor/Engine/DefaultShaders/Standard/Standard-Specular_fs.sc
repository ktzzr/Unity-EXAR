...
void main ()
{
  ...
  tmpvar_16 = (_BumpScale * ((texture2D (_BumpMap, tmpvar_19).xyz * 2.0) - 1.0));
  ...
  tmpvar_23 = ((xlv_TEXCOORD0 * _SpecGlossMap_ST.xy) + _SpecGlossMap_ST.zw);
  lowp vec4 tmpvar_24 = vec4(0.0);
  tmpvar_24 = texture2D (_SpecGlossMap, tmpvar_23);
  tex2DNode36_18 = tmpvar_24;
  tmpvar_15 = tex2DNode36_18.xyz;
  tmpvar_17 = (tex2DNode36_18.w * _GlossMapScale);
  ...
  tmpvar_27 = dot (xlv_TEXCOORD1.xyz, tmpvar_16);
  worldN_5.x = tmpvar_27;
  highp float tmpvar_28 = 0.0;
  tmpvar_28 = dot (xlv_TEXCOORD2.xyz, tmpvar_16);
  worldN_5.y = tmpvar_28;
  highp float tmpvar_29 = 0.0;
  tmpvar_29 = dot (xlv_TEXCOORD3.xyz, tmpvar_16);
  ...
  albedo_45 = tmpvar_14;
  mediump vec3 specColor_46 = vec3(0.0);
  specColor_46 = tmpvar_15;
  mediump float oneMinusReflectivity_47 = 0.0;
   ...
   * 
    ...
    clamp ((tmpvar_17 + (1.0 - oneMinusReflectivity_47)), 0.0, 1.0)
  ), vec3(
    ((x_57 * x_57) * (x_57 * x_57))
  ))));
