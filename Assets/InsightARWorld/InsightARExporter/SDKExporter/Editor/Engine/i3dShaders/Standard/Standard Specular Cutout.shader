...
Shader "i3dEngine/Standard Specular Cutout"
{
	Properties
	{
	...
	SubShader
	{
		Tags{ "RenderType" = "TransparentCutout"  "Queue" = "AlphaTest" "IgnoreProjector" = "True" "IsEmissive" = "true"  }
		ZWrite On
		Cull Back
		CGINCLUDE
		...
		ENDCG
		CGPROGRAM
		#pragma surface surf StandardSpecular alphatest:_Cutoff keepalpha fullforwardshadows 
