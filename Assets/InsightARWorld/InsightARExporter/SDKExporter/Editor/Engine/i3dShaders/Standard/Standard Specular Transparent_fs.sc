...
void main ()
{
  ...
  tmpvar_32 = dot (xlv_TEXCOORD3.xyz, tmpvar_16);
  ...
  albedo_48 = tmpvar_14;
  mediump vec3 specColor_49 = vec3(0.0);
  specColor_49 = tmpvar_15;
  mediump float oneMinusReflectivity_50 = 0.0;
   ...
   * 
    ...
    clamp ((tmpvar_17 + (1.0 - oneMinusReflectivity_50)), 0.0, 1.0)
  ), vec3(
    ((x_61 * x_61) * (x_61 * x_61))
  ))));
