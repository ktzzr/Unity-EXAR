Shader "i3dEngine/UnlitGreenMovie"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			uniform float4 _ReplacedColor;
			uniform float _LowerThreshold1;
			uniform float _HigherThreshold1;
			uniform float _LowerThreshold2;
			uniform float _HigherThreshold2;
