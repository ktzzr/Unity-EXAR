...
function GameTrackInitState(gameObject)
{
    this.gameObject = gameObject;
    this.transform = gameObject.transform;
}
//Write prototype function here
GameTrackInitState.prototype = Object.assign(Object.create(Object.prototype), {
    ...
    Init: function()
    {
	    ...
	    //Fw_Event_SetMapVisibility("0");
        g_ResManager.locationPanelTrans.gameObject.setActive(true);  
        //关闭模型和POI显示
        g_ResManager.modelRootTrans.gameObject.setActive(false);
        g_ResManager.poiTrans.gameObject.setActive(false);
    },
    StartInitView: function()
    {
        ...
        //g_ResManager.initTxtTrans.gameObject.setActive(true);
    ...
    {
        g_ResManager.initIconTrans.gameObject.setActive(false);
        //g_ResManager.initTxtTrans.gameObject.setActive(false);
        g_ResManager.initSlideTrans.gameObject.setActive(false);
    ...
    GetState: function()
    {
	    return g_GameStatus.GAME_STATUS_TRACK_INIT;
    }
});
