...
GameManager.prototype = Object.assign(Object.create(Object.prototype), {
    ...
    Start: function () {
        ...
        g_GameStateCtrl = this.gameObject.getComponent("Assets/InsightARWorld/InsightARExporter/Utility/BuiltinJSScripts/Location/PoiMode/POIGameStateCtrl.js",0);
        ...
        g_ResManager = this.gameObject.getComponent("Assets/InsightARWorld/InsightARExporter/Utility/BuiltinJSScripts/Location/PoiMode/POIResourceManager.js",0);
    ...
    // onDestinationChanged: function(id)
    // {
    //     Insight.Debug.Log("js call on click poi handler" + id);
