	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
...
#endif
				float2 uv_BG = i.ase_texcoord1.xy * _BG_ST.xy + _BG_ST.zw;
				float4 tex2DNode585 = tex2D( _BG, uv_BG );
				float2 uv0759 = float4(i.ase_texcoord1.xy,0,0).xy * float2( 1,1 ) + float2( 0,0 );
				...
				float4 lerpResult562 = lerp( tex2DNode585 , tex2D( _Video_Input, lerpResult762 ) , saturate( ( ( pow( ( _Mask_Ctrl * ( 1.0 - tex2DNode756.a ) ) , _Power ) - saturate( min( ( 1.0 - pow( ( _Mask_Ctrl * ( 1.0 - tex2DNode756.a ) ) , _Power ) ) , ( ( hsvTorgb588.z - hsvTorgb587.z ) * _Strenth ) ) ) ) + saturate( min( ( ( hsvTorgb587.z - hsvTorgb588.z ) * _Strenth ) , pow( ( _Mask_Ctrl * ( 1.0 - tex2DNode756.a ) ) , _Power ) ) ) ) ));
				
				
				finalColor = lerpResult562;
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=18200
-2203;930;1633;1050;228.5728;-1293.855;1;True;True
...
Node;AmplifyShaderEditor.CommentaryNode;733;-1493.618,856.3923;Inherit;False;2713.178;1137.424;抠像过程;28;585;623;587;616;589;593;603;592;584;595;640;591;639;594;596;666;665;557;560;562;588;621;732;730;731;760;763;762;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;763;291.4272,1712.855;Inherit;False;Property;_videoV_Invert;videoV_Invert;11;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;557;588.7134,1670.019;Inherit;True;Property;_Video_Input;Video_Input;3;0;Create;True;0;0;False;0;False;-1;None;46a188949cfa34a8188f0720fce3dbcb;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;128;1083.597,1119.819;Float;False;True;-1;2;ASEMaterialInspector;100;1;EZXR/SkyExtract_Quad;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;0;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;7;False;-1;True;True;0;False;-1;0;False;-1;True;1;RenderType=Opaque=RenderType;True;2;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;1;True;False;;0
...
WireConnection;562;2;665;0
WireConnection;128;0;562;0
ASEEND*/
//CHKSM=8A6B3C48542D661B9847AD3D55AA49603628BACC