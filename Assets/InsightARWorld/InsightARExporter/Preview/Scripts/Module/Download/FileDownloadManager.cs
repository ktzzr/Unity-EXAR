...
{
    #region params
    private const string TAG = "FileDownloadManager";
    ...
    private void ThreadLoop()
    {
        while (true)
        {
            ...
            {
                InsightDebug.Log(TAG, "Error FileDownloadState " + task.State + " " + task.GetDownloadTask().FileName);
                break;
            }
        }
    ...
    private void UpdateComplete()
    {
        ...
        foreach (var downloadTask in completeArr)
        {
            ...
            if (downloadTask.completeFun != null)
            {
                ...
                {
                    InsightDebug.LogError(TAG,"UpdateComplete " + ex.Message);
                }
            }
        }
    }
