...
namespace Duktape
{
    ...
    public class Prefs
    {
        ...
        // 静态绑定代码的生成目录
        public string outDir = "Assets/InsightARWorld/Generated";
        public string typescriptDir = "Assets/InsightARWorld/Generated";

        public List<string> cleanupDir = new List<string>(new string[]
        {
            "Assets/InsightARWorld/Generated",
        });
        ...
        // public string tsDir = "Assets/InsightARWorld/Scripts/Source/duktape";
        // public string jsDir = "Assets/InsightARWorld/Scripts/Generated/duktape";
