...
namespace Duktape
{
    ...
    public partial class BindingManager
    {
        ...
        //修改导出命名空间
        public static bool isInsightNameSpace = true;
        public static bool isMethodNameStartCharLowerCase = true;
        public static bool isFileNameWrapSuffix = true;
        public const string STRINSIGHT = "Insight";
        public const string STRWRAPPER = "Wrap";
    ...
    private void ExportBuiltins()
    {
        ...
        AddExportedType(typeof(Object));
    //    AddExportedType(typeof(Vector3)); //comment by wy
    }
