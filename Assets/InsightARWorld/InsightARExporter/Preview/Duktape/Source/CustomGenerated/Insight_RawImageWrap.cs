...
namespace DuktapeJS {
    ...
    public class DuktapeJS_UnityEngine_RawImage : DuktapeBinding {
        [UnityEngine.Scripting.Preserve]
        ...
        public static int Bind_getMaterial(IntPtr ctx)
        {
            try
            {
                ...
                var ret = Insight.RawImageExtension.getMaterial(self);
        ...
        public static int Bind_setMaterial(IntPtr ctx)
        {
            try
            {
                ...
                Insight.RawImageExtension.setMaterial(self, arg0);
                return 0;
            }
            catch (Exception exception)
            {
        ...
        public static int Bind_getColor(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.RawImageExtension.getColor(self);
                duk_push_classvalue(ctx, ret);
                return 1;
            }
            catch (Exception exception)
        ...
        public static int Bind_setColor(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, 0, out arg0);
                Insight.RawImageExtension.setColor(self, arg0);
                return 0;
            }
            catch (Exception exception)
            {
        ...
        public static int Bind_toString(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.RawImageExtension.toString(self);
        ...
        public static int Bind_getEnabled(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.RawImageExtension.getEnabled(self);
        ...
        public static int Bind_setEnabled(IntPtr ctx)
        {
            try
            {
                ...
                Insight.RawImageExtension.setEnabled(self, arg0);
                return 0;
            }
            catch (Exception exception)
            {
        ...
        public static int Bind_gameObject(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.RawImageExtension.gameObject(self);
                duk_push_classvalue(ctx, ret);
                return 1;
            }
            catch (Exception exception)
        ...
        public static int Bind_isActiveAndEnabled(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.RawImageExtension.isActiveAndEnabled(self);
                DuktapeDLL.duk_push_boolean(ctx, ret);
                return 1;
            }
            catch (Exception exception)
        ...
        public static int Bind_name(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.RawImageExtension.name(self);
                DuktapeDLL.duk_push_string(ctx, ret);
                return 1;
            }
            catch (Exception exception)
        ...
        public static int Bind_tag(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.RawImageExtension.tag(self);
                DuktapeDLL.duk_push_string(ctx, ret);
                return 1;
            }
            catch (Exception exception)
        ...
        public static int Bind_transform(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.RawImageExtension.transform(self);
                duk_push_classvalue(ctx, ret);
                return 1;
            }
            catch (Exception exception)
        ...
        [UnityEngine.Scripting.Preserve]
        [AOT.MonoPInvokeCallbackAttribute(typeof(DuktapeDLL.duk_c_function))]
        public static int BindRead_texture(IntPtr ctx)
        {
            try
            {
                UnityEngine.UI.RawImage self;
        ...
        [UnityEngine.Scripting.Preserve]
        [AOT.MonoPInvokeCallbackAttribute(typeof(DuktapeDLL.duk_c_function))]
        public static int BindWrite_texture(IntPtr ctx)
        {
            try
            {
                UnityEngine.UI.RawImage self;
        ...
        public static int reg(IntPtr ctx)
        {
            ...
            duk_begin_class(ctx, "RawImage", typeof(UnityEngine.UI.RawImage), object_private_ctor);
            ...
            duk_add_property(ctx, "texture", BindRead_texture, BindWrite_texture, -1);
            duk_end_class(ctx);
