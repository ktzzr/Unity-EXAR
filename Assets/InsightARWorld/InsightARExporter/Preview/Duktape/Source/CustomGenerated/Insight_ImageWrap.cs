...
namespace DuktapeJS {
    ...
    public class DuktapeJS_UnityEngine_Image : DuktapeBinding {
        ...
        public static int Bind_toString(IntPtr ctx)
        {
            try
            {
                ...
                var ret = Insight.ImageExtension.toString(self);
        ...
        public static int Bind_getEnabled(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.ImageExtension.getEnabled(self);
        ...
        public static int Bind_setEnabled(IntPtr ctx)
        {
            try
            {
                ...
                Insight.ImageExtension.setEnabled(self, arg0);
                return 0;
            }
            catch (Exception exception)
            {
        ...
        public static int Bind_gameObject(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.ImageExtension.gameObject(self);
        ...
        public static int Bind_isActiveAndEnabled(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.ImageExtension.isActiveAndEnabled(self);
                DuktapeDLL.duk_push_boolean(ctx, ret);
                return 1;
            }
            catch (Exception exception)
        ...
        public static int Bind_name(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.ImageExtension.name(self);
                DuktapeDLL.duk_push_string(ctx, ret);
                return 1;
            }
            catch (Exception exception)
        ...
        public static int Bind_tag(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.ImageExtension.tag(self);
                DuktapeDLL.duk_push_string(ctx, ret);
                return 1;
            }
            catch (Exception exception)
        ...
        public static int Bind_transform(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.ImageExtension.transform(self);
                duk_push_classvalue(ctx, ret);
                return 1;
            }
            catch (Exception exception)
        ...
        public static int Bind_getColor(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.ImageExtension.getColor(self);
                duk_push_classvalue(ctx, ret);
                return 1;
            }
            catch (Exception exception)
        ...
        public static int Bind_setColor(IntPtr ctx)
        {
            try
            {
                ...
                Insight.ImageExtension.setColor(self, arg0);
                return 0;
            }
            catch (Exception exception)
            {
        ...
        [UnityEngine.Scripting.Preserve]
        [AOT.MonoPInvokeCallbackAttribute(typeof(DuktapeDLL.duk_c_function))]
        public static int BindRead_sprite(IntPtr ctx)
        {
            try
            {
                UnityEngine.UI.Image self;
        ...
        [UnityEngine.Scripting.Preserve]
        [AOT.MonoPInvokeCallbackAttribute(typeof(DuktapeDLL.duk_c_function))]
        public static int BindWrite_sprite(IntPtr ctx)
        {
            try
            {
                UnityEngine.UI.Image self;
        ...
        public static int reg(IntPtr ctx)
        {
            ...
            duk_begin_class(ctx, "Image", typeof(UnityEngine.UI.Image), object_private_ctor);
            duk_add_property(ctx, "color", Bind_getColor, Bind_setColor, -1);
            duk_add_property(ctx, "sprite", BindRead_sprite, BindWrite_sprite, -1);
