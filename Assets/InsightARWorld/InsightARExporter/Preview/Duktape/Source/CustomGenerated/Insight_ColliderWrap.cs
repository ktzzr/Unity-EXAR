...
namespace DuktapeJS {
    ...
    public class DuktapeJS_UnityEngine_Collider : DuktapeBinding {
        [UnityEngine.Scripting.Preserve]
        ...
        public static int Bind_toString(IntPtr ctx)
        {
            try
            {
                ...
                var ret = Insight.ColliderExtension.toString(self);
        ...
        public static int Bind_gameObject(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.ColliderExtension.gameObject(self);
        ...
        public static int Bind_isActiveAndEnabled(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.ColliderExtension.isActiveAndEnabled(self);
        ...
        public static int Bind_name(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.ColliderExtension.name(self);
                DuktapeDLL.duk_push_string(ctx, ret);
                return 1;
            }
            catch (Exception exception)
        ...
        public static int Bind_tag(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.ColliderExtension.tag(self);
                DuktapeDLL.duk_push_string(ctx, ret);
                return 1;
            }
            catch (Exception exception)
        ...
        public static int Bind_transform(IntPtr ctx)
        {
            try
            {
                ...
                duk_get_classvalue(ctx, -1, out self);
                DuktapeDLL.duk_pop(ctx);
                var ret = Insight.ColliderExtension.transform(self);
                duk_push_classvalue(ctx, ret);
                return 1;
            }
            catch (Exception exception)
        ...
        [UnityEngine.Scripting.Preserve]
        [AOT.MonoPInvokeCallbackAttribute(typeof(DuktapeDLL.duk_c_function))]
        public static int BindWrite_isTrigger(IntPtr ctx)
        {
            try
            {
                UnityEngine.Collider self;
        ...
        public static int reg(IntPtr ctx)
        {
            ...
            duk_begin_class(ctx, "Collider", typeof(UnityEngine.Collider), BindConstructor);
