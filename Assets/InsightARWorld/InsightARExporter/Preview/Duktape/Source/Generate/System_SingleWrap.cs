...
namespace DuktapeJS {
    ...
    public class DuktapeJS_System_Single : DuktapeBinding {
        [UnityEngine.Scripting.Preserve]
                ...
                do
                {
                    if (argc == 1)
                    {
                        if (duk_match_types(ctx, argc, typeof(object)))
                        {
                            ...
                            self = (float)DuktapeDLL.duk_get_number(ctx, -1);
        ...
        public static int reg(IntPtr ctx)
        {
            ...
            duk_begin_class(ctx, "Single", typeof(float), object_private_ctor);
            ...
            duk_add_const(ctx, "MinValue", -3.402823E+38, -2);
            duk_add_const(ctx, "Epsilon", 1.401298E-45, -2);
            duk_add_const(ctx, "MaxValue", 3.402823E+38, -2);
