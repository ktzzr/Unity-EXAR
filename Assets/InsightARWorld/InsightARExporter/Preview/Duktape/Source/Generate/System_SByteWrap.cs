...
namespace DuktapeJS {
    ...
    public class DuktapeJS_System_SByte : DuktapeBinding {
        [UnityEngine.Scripting.Preserve]
                ...
                do
                {
                    if (argc == 1)
                    {
                        if (duk_match_types(ctx, argc, typeof(object)))
                        {
                            ...
                            self = (sbyte)DuktapeDLL.duk_get_int(ctx, -1);
                        ...
                        if (duk_match_types(ctx, argc, typeof(sbyte)))
                        {
                            sbyte self;
                            DuktapeDLL.duk_push_this(ctx);
                            self = (sbyte)DuktapeDLL.duk_get_int(ctx, -1);
        ...
        public static int reg(IntPtr ctx)
        {
            ...
            duk_begin_class(ctx, "SByte", typeof(sbyte), object_private_ctor);
            ...
            duk_add_const(ctx, "MaxValue", 127, -2);
            duk_add_const(ctx, "MinValue", -128, -2);
            duk_end_class(ctx);
