...
namespace DuktapeJS {
    ...
    public class DuktapeJS_System_UInt16 : DuktapeBinding {
        [UnityEngine.Scripting.Preserve]
                ...
                do
                {
                    if (argc == 1)
                    {
                        if (duk_match_types(ctx, argc, typeof(object)))
                        {
                            ...
                            self = (ushort)DuktapeDLL.duk_get_int(ctx, -1);
                        ...
                        if (duk_match_types(ctx, argc, typeof(ushort)))
                        {
                            ushort self;
                            DuktapeDLL.duk_push_this(ctx);
                            self = (ushort)DuktapeDLL.duk_get_int(ctx, -1);
        ...
        public static int reg(IntPtr ctx)
        {
            ...
            duk_begin_class(ctx, "UInt16", typeof(ushort), object_private_ctor);
            ...
            duk_add_const(ctx, "MaxValue", 65535, -2);
