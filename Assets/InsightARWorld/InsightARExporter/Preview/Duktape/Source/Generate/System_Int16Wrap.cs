...
namespace DuktapeJS {
    ...
    public class DuktapeJS_System_Int16 : DuktapeBinding {
        [UnityEngine.Scripting.Preserve]
                ...
                do
                {
                    if (argc == 1)
                    {
                        if (duk_match_types(ctx, argc, typeof(object)))
                        {
                            ...
                            self = (short)DuktapeDLL.duk_get_int(ctx, -1);
                        ...
                        if (duk_match_types(ctx, argc, typeof(short)))
                        {
                            short self;
                            DuktapeDLL.duk_push_this(ctx);
                            self = (short)DuktapeDLL.duk_get_int(ctx, -1);
        ...
        public static int reg(IntPtr ctx)
        {
            ...
            duk_begin_class(ctx, "Int16", typeof(short), object_private_ctor);
            ...
            duk_add_const(ctx, "MaxValue", 32767, -2);
            duk_add_const(ctx, "MinValue", -32768, -2);
            duk_end_class(ctx);
