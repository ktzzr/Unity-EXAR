...
namespace DuktapeJS {
    ...
    public class DuktapeJS_System_Byte : DuktapeBinding {
        [UnityEngine.Scripting.Preserve]
                ...
                do
                {
                    if (argc == 1)
                    {
                        if (duk_match_types(ctx, argc, typeof(object)))
                        {
                            ...
                            self = (byte)DuktapeDLL.duk_get_int(ctx, -1);
        ...
        public static int reg(IntPtr ctx)
        {
            ...
            duk_begin_class(ctx, "Byte", typeof(byte), object_private_ctor);
            ...
            duk_add_const(ctx, "MaxValue", 255, -2);
