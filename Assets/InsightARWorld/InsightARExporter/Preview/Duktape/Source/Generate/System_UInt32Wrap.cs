...
namespace DuktapeJS {
    ...
    public class DuktapeJS_System_UInt32 : DuktapeBinding {
        [UnityEngine.Scripting.Preserve]
                ...
                do
                {
                    if (argc == 1)
                    {
                        if (duk_match_types(ctx, argc, typeof(object)))
                        {
                            ...
                            self = DuktapeDLL.duk_get_uint(ctx, -1);
                        ...
                        if (duk_match_types(ctx, argc, typeof(uint)))
                        {
                            uint self;
                            DuktapeDLL.duk_push_this(ctx);
                            self = DuktapeDLL.duk_get_uint(ctx, -1);
            ...
            try
            {
                ...
                do
                {
                    if (argc == 4)
                    {
                        ...
                        {
                            DuktapeDLL.duk_push_uint(ctx, arg3);
                    ...
                    if (argc == 2)
                    {
                        ...
                        {
                            DuktapeDLL.duk_push_uint(ctx, arg1);
        ...
        public static int reg(IntPtr ctx)
        {
            ...
            duk_begin_class(ctx, "UInt32", typeof(uint), object_private_ctor);
            ...
            duk_add_const(ctx, "MaxValue", 4294967295, -2);
            duk_add_const(ctx, "MinValue", 0, -2);
            duk_end_class(ctx);
