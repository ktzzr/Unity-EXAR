...
namespace EZXR.CloudPlayBack
{
    ...
    public static class GameViewUtils
    {
        ...
        //{
        //    Debug.Log(SizeExists(GameViewSizeGroupType.Android, 1920, 1080));
        //}
        ...
        public static void AddResolution(GameViewSizeType viewSizeType, GameViewSizeGroupType sizeGroupType, int width, int height, string label)
        {
            ...
            object group = getGroup.Invoke(instance, new object[] { (int)sizeGroupType });
            ...
            object entry = constructorInfo.Invoke(new object[] { (int)viewSizeType, width, height, label });
