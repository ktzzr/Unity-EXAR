...
public static class EditorHelper
{
	...
	private static void OnScriptsReloaded()
	{
		...
		{
			POIMap poiMap = UnityEngine.Object.FindObjectOfType<POIMap>();
	...
	{
		EZXRDataProperty targetObjectAsDataProperty = GetMapboxDataPropertyObject(targetObject);
	...
	public static EZXRDataProperty GetMapboxDataPropertyObject<T>(T targetObject)
	{
		return targetObject as EZXRDataProperty;
	}

	public static bool DidModifyProperty<T>(SerializedProperty property, T targetObject)
	{
		EZXRDataProperty targetObjectAsDataProperty = targetObject as EZXRDataProperty;
